 ...
 *
 * <p>
 * A writer service typically outputs information about a trail to a file in a
 * particular format (GPX, KML, GeoJSON, etc.).
 *
 * <p>
...
public interface Writer extends BiConsumer<Trail, Path> {
     ...
     * the writing process to finish successfully.
     */
    @Override
