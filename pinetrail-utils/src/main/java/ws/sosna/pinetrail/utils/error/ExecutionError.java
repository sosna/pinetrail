...
/**
 * Error thrown when one of the Pinetrail processes fails to complete
 * successfully.
 *
 * <p>
 * The error should contain enough information so as to be useful to the upper
 * layers (e.g.: GUI).
 *
...
public final class ExecutionError extends RuntimeException {
     ...
     */
    public ExecutionError(final String message, final Throwable cause,
        final Marker marker, final Actions action,
