...
/**
 * The coordinates of a point in a 3-dimensional plan: longitude (x), latitude (y) and elevation
 * (z).
 *
 * <p>A new immutable instance can be obtained using a {@link CoordinatesBuilder}:<br>
 * <code>
 * Coordinates point =
