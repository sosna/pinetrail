...
public final class CoordinatesBuilder implements Builder<Coordinates> {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(CoordinatesBuilder.class);

  /**
   * Instantiates a new CoordinatesBuilder, with all mandatory fields.
   *
   * <p>The {@code longitude} cannot be null, must be superior or equal to -180.0 and inferior to
   * 180.0 degrees.
   *
   * <p>The {@code latitude} cannot be null and must be between or equal to -90.0 and 90.0 degrees.
   *
   ...
   *
   * <p>The value cannot be null and must be between or equal to -90.0 and 90.0 degrees.
   *
   * @param latitude the latitude of the point, in decimal degrees
   ...
   *
   * <p>On earth, the elevation should be between -450 and 9000 meters (Mt. Everest culminates at
   * 8850m, while the lowest point on dry land is at -418m). If you happen to be on another planet,
  ...
  /**
   * Instantiate a new CoordinatesBuilder out of an existing {@code Coordinates} instance.
   *
   * <p>All objects are immutable and, therefore cannot be updated. This method is a convenience
   * method that creates a new builder with the same values as the supplied {@code Coordinates}. The
  ...
  public static CoordinatesBuilder of(final Coordinates coordinates) {
    final CoordinatesBuilder bld =
        new CoordinatesBuilder(coordinates.getLongitude(), coordinates.getLatitude());
  ...
  public Coordinates build() {
    final Coordinates obj = new CoordinatesImpl(longitude, latitude, elevation);
    LOGGER.debug(
  ...
  private static final class CoordinatesImpl implements Coordinates {
    ...
    CoordinatesImpl(final Double longitude, final Double latitude, final Double elevation) {
      super();
      this.latitude = latitude;
      this.longitude = longitude;
      this.elevation = elevation;
