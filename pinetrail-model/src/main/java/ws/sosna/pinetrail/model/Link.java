 ...
 *
 * <p>This can be used to point to additional information (for example a Wikipedia entry) about a
 * {@code Trail} or a {@code Waypoint}.
 *
 * <p>A new immutable instance can be obtained using a {@link LinkBuilder}:<br>
...
public interface Link extends Serializable {
   ...
   *
   * <p>The link cannot be null or empty.
   *
   ...
   *
   * <p>The {@code URI} cannot be null and it must be a valid URL according to RFC2396.
   *
