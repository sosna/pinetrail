...
public final class LinkBuilder implements Builder<Link> {
     ...
     *
     * <p>
     * Neither the {@code label} nor the {@code location} can be null or empty.
     * The {@code location} must be a valid URL according to RFC2396.
     *
     ...
     *
     * <p>
     * It cannot be null and it must be a valid URL according to RFC2396.
     *
     * @param location the location of the external resource
     ...
     * as the supplied {@code Link}. The setters methods of the builder can then
     * be used to update some fields before calling the {@code build} method.
     *
    ...
    private static final class LinkImpl implements Link {
        ...
        public boolean equals(final Object obj) {
            ...
            return Objects.equals(this.label, other.getLabel()) && Objects.
                    equals(
