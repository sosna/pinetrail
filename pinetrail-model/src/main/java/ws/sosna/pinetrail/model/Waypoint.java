 ...
 *
 * <p>
 * A point is identified by its coordinates, as measured at a certain point in
 * time.
 *
 * <p>
 * Additional information can be given about the point, such as a {@code name},
 * a {@code description} or {@code link}s to online resources. This is useful to
 * indicate, for example, the location of a famous landmark, a nice restaurant,
 * or an impressive viewpoint.
 *
 * <p>
 * A new immutable instance can be obtained using a {@code WaypointBuilder}:<br>
 * <code>
...
public interface Waypoint extends Describable, Comparable<Waypoint> {
     ...
     *
     * <p>
     * The coordinates are mandatory and cannot be null.
     *
    ...
    /**
     * The type of point of interest such as a castle, a religious building, a
     * viewpoint, etc.
     *
     * <p>
     * Many waypoints simply represent a GPS recording at a certain point in
     * time. Others however represent a location worth documenting or visiting
     * again, such as a museum, a castle, a point offering a nice panoramic
     * view, etc.
     *
     ...
     *
     * @return the speed, in km per hours, with which the distance between this
    ...
    /**
     * Whether the waypoint is sufficiently distant from the previous one to
     * consider that the person recording the trail was in movement.
     *
     * <p>
     ...
     * Defaults to true.
     *
     * @return whether the waypoint is sufficiently distant from the previous
     * one to consider that the person recording the trail was in movement.
     */
    boolean isActive();
