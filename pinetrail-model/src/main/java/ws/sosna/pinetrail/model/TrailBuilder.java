...
public final class TrailBuilder extends DescribableBuilder<TrailBuilder>
     ...
     *
     * <p>
     * Neither the {@code name} nor the collection of {@code waypoints} can be
     * null or empty.
     *
     ...
     *
     * <p>
     * The list cannot be null and must contain at least one waypoint. The
     * points will be sorted by time, in ascending order.
     *
     * @param points the ordered list of points describing the trail
     ...
     * as the supplied {@code Trail}. The setters methods of the builder can
