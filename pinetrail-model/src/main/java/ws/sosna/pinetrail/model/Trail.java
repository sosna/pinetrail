 ...
 *
 * <p>
 * This is typically a GPS recording of a path followed during some outdoor
 * activity. It is roughly equivalent to what is known as a track in the GPX
 * format, or a linestring in GeoJSON or KML.
 *
 * <p>
 * A new immutable instance can be obtained using a {@code TrailBuilder}:<br>
 * <code>
...
public interface Trail extends Describable {
     ...
     *
     * <p>
     * The list is immutable and is sorted by time, in ascending order. The list
     * cannot be null and must contain at least one waypoint.
     *
     ...
     *
     * <p>
     * The rating will be guessed from the elevation gain and the distance of
     * the trail.
     *
     ...
     *
     * <p>
     * The value represents the type of activity performed when following the
     * trail, such as hiking, jogging or biking.
     *
     * <p>
     * The value can be null and the activity will be guessed from the average
     * speed.
     *
