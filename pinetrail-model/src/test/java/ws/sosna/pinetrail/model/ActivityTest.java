...
public class ActivityTest {
  ...
  public void guessHikingLevel() {
    ...
    final Integer rating =
        activity.getDifficultyRating(
            Level.INTERMEDIATE,
            getStats().getDistanceSummary(),
            getStats().getElevationDifferenceSummary(),
            Instant.parse("2014-05-18T08:25:32Z"),
            Instant.parse("2014-05-18T08:27:26Z"));
    assertTrue(8 == rating);
  }
  ...
  public void guessLevelSeveralDays() {
    ...
    final Integer rating =
        activity.getDifficultyRating(
            ...
            getStats().getElevationDifferenceSummary(),
            Instant.parse("2014-05-18T08:25:32Z"),
            Instant.parse("2014-05-19T08:27:26Z"));
    assertTrue(6 == rating);
  }

  private TrailStatistics getStats() {
    final Set<Waypoint> points = PointsAugmenter.INSTANCE.apply(getTestPoints());
  ...
  private SortedSet<Waypoint> getTestPoints() {
    ...
    points.add(getPoint(8.739481, 50.182336, 214.03, "2014-05-18T08:25:32Z"));
    points.add(getPoint(8.773227, 50.230132, 215.47, "2014-05-18T09:46:14Z"));
    points.add(getPoint(8.939867, 50.288352, 216.43, "2014-05-18T14:27:02Z"));
    return points;
  }
